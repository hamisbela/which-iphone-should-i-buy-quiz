    ...
    <footer className="bg-gray-900 text-gray-300 mt-24">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-bold text-xl text-white">Which iPhone Should I Buy?</span>
          </div>
          <p className="text-gray-400">
            Your trusted companion in finding the perfect iPhone for your needs.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center gap-2">
              <Mail size={16} />
              <span>support@iphoneguide.com</span>
            </li>
            <li className="flex items-center gap-2">
              <Phone size={16} />
        ...
        <div>
          ...
          <p className="text-gray-400 mb-4">Subscribe to get the latest iPhone news and deals.</p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-6 text-center text-gray-400">
          © {new Date().getFullYear()} iPhone Guide. All rights reserved. As an Amazon Associate I earn from qualifying purchases.
        </div>
      </div>
    </footer>
  );
