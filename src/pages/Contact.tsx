    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Have questions about finding the right iPhone? We're here to help. Reach out to us through any of the following channels.
        </p>
      </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="How can we help you find the perfect iPhone?"
                />
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@iphoneguide.com</p>
                </div>
              </div>
